...
export class SavannatechDb1703644784311 implements MigrationInterface {
    name = 'SavannatechDb1703644784311'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "authToken" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "lastUsed" TIMESTAMP NOT NULL DEFAULT '"2023-12-27T02:39:47.437Z"', "credentialTokenId" integer, "userEmail" character varying, CONSTRAINT "PK_eb8fa60b49ec49031fa0cab6d3e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "jobs" ADD CONSTRAINT "FK_52eb1e9bce5a39e82266a9b42aa" FOREIGN KEY ("role_id") REFERENCES "applications"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
