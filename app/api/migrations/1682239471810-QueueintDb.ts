...
export class QueueintDb1682239471810 implements MigrationInterface {
    name = 'QueueintDb1682239471810'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "authToken" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "lastUsed" TIMESTAMP NOT NULL DEFAULT '"2023-04-23T08:44:35.274Z"', "credentialTokenId" integer, "userEmail" character varying, CONSTRAINT "PK_eb8fa60b49ec49031fa0cab6d3e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "advertisement" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "description" character varying NOT NULL DEFAULT '', "text" character varying NOT NULL DEFAULT '', "imageUrl" character varying NOT NULL DEFAULT '', "currency" character varying NOT NULL DEFAULT 'USD', "price" character varying, "base64Img" bytea NOT NULL, "queueGroupId" integer, CONSTRAINT "PK_c8486834e5ef704ec05b7564d89" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "queueArea" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "name" character varying, "queueGroupId" integer, CONSTRAINT "PK_d7ae85e1fdafaf25b91e48df45c" PRIMARY KEY ("id"))`);
