...
export class SavannatechDb1700492505302 implements MigrationInterface {
    name = 'SavannatechDb1700492505302'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "applications" ("id" SERIAL NOT NULL, "resume" character varying NOT NULL, "years_of_experience" integer NOT NULL, "background_questions" text NOT NULL, "cover_letter" character varying NOT NULL, "status" character varying NOT NULL, "role_id" integer, "developer_id" integer, CONSTRAINT "PK_938c0a27255637bde919591888f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "developer" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "name" character varying NOT NULL, "skills" text NOT NULL, "phone_number" character varying NOT NULL, "years_of_experience" integer NOT NULL, "address" character varying NOT NULL, "role_status" character varying NOT NULL, "user_id" uuid, CONSTRAINT "PK_71b846918f80786eed6bfb68b77" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "authToken" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "lastUsed" TIMESTAMP NOT NULL DEFAULT '"2023-11-20T15:01:47.618Z"', "credentialTokenId" integer, "userEmail" character varying, CONSTRAINT "PK_eb8fa60b49ec49031fa0cab6d3e" PRIMARY KEY ("id"))`);
