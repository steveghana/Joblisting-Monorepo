...
const Demo = ({
  ...
  const initialValues: InterviewFormValue = {
    ...
    starttime: new Date().getTime().toLocaleString(),
    endtime: new Date().getTime().toLocaleString(),
  ...
  const validationSchema = Yup.object({
    eventType: Yup.string().required("Interview type is required"),
        ...
        >
          {({
            ...
            <Form>
                      ...
                      <DemoItem label="End meeting time">
                        ...
                        <Field
                          ...
                          defaultValue={addMinutes(
                            addHours(startOfDay(new Date()), 15),
                            30
                          )}
                          label="End meeting time"
                          type="time"
              ...
              <Divider
                sx={{ border: "1px solid rgba(128, 128, 128, 0.158)" }}
              />
            </Form>
          )}
        </Formik>
